...
corresponding to 4 scores obtained by a student. Calculate the average with weights 2, 3, 4 e 1 respectively, 
...
elif resp>=5 and resp<7:
    print("Media: %.1f"%resp)
    print("Aluno em exame.")
    exame=float(input())
    med_fin=(exame+resp)/2
    if med_fin>=5:
        print("Aluno aprovado.")
        print("Media final: %.1f"%med_fin)
    elif med_fin<5:
        print("Aluno reprovado.")
        print("Media final: %.1f"%med_fin)
